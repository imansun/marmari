...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ShipmentScheduleItemDetailHistory' })
export class LegacyShipmentScheduleItemDetailHistory {
  @PrimaryColumn({ type: 'bigint', name: 'ShipmentScheduleItemDetailHistoryID' })
  shipmentScheduleItemDetailHistoryID: number;
