...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'RfidCommandScheduleItem' })
export class LegacyRfidCommandScheduleItem {
  @PrimaryColumn({ type: 'bigint', name: 'RfidCommandScheduleItemID' })
  rfidCommandScheduleItemID: number;
