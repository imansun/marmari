...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'StockTakingWithTrackingFactorItem' })
export class LegacyStockTakingWithTrackingFactorItem {
  @PrimaryColumn({ type: 'bigint', name: 'StockTakingWithTrackingFactorItemID' })
  stockTakingWithTrackingFactorItemID: number;
  ...
  @Column({ type: 'numeric', name: 'FirstComputation', nullable: true })
  firstComputation: number | null;
