...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'StockTakingWithTrackingFactorThirdCountItem' })
export class LegacyStockTakingWithTrackingFactorThirdCountItem {
  @PrimaryColumn({ type: 'bigint', name: 'StockTakingWithTrackingFactorThirdCountItemID' })
  stockTakingWithTrackingFactorThirdCountItemID: number;
  ...
  @Column({ type: 'numeric', name: 'PartRemQty', nullable: true })
  partRemQty: number | null;

  @Column({ type: 'numeric', name: 'ThirdComputation', nullable: true })
  thirdComputation: number | null;
