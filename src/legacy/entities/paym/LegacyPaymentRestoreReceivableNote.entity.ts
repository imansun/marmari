...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'PaymentRestoreReceivableNote' })
export class LegacyPaymentRestoreReceivableNote {
  @PrimaryColumn({ type: 'bigint', name: 'PaymentRestoreReceivableNoteID' })
  paymentRestoreReceivableNoteID: number;
