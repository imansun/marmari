...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'PaymentOrderCashMoney' })
export class LegacyPaymentOrderCashMoney {
  @PrimaryColumn({ type: 'bigint', name: 'PaymentOrderCashMoneyID' })
  paymentOrderCashMoneyID: number;
