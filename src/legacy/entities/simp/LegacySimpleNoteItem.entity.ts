...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'SimpleNoteItem' })
export class LegacySimpleNoteItem {
  @PrimaryColumn({ type: 'bigint', name: 'SimpleNoteItemID' })
  simpleNoteItemID: number;

  @Column({ type: 'bigint', name: 'SimpleNoteRef' })
  simpleNoteRef: number;
