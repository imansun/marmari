...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'CustomerExtraFields' })
export class LegacyCustomerExtraFields {
  @PrimaryColumn({ type: 'bigint', name: 'CustomerExtraFieldsID' })
  customerExtraFieldsID: number;
