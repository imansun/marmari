...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'TransferVoucherSpecificationSL' })
export class LegacyTransferVoucherSpecificationSL {
  @PrimaryColumn({ type: 'bigint', name: 'TransferVoucherSpecificationSLID' })
  transferVoucherSpecificationSLID: number;
