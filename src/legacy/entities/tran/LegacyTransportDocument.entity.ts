...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'TransportDocument' })
export class LegacyTransportDocument {
  @PrimaryColumn({ type: 'bigint', name: 'TransportDocumentID' })
  transportDocumentID: number;

  @Column({ type: 'character varying', name: 'Number' })
  number: string;

  @Column({ type: 'timestamp without time zone', name: 'TransportDocumentDate' })
  ...
  @Column({ type: 'bigint', name: 'ShipmentSourceRef', nullable: true })
  shipmentSourceRef: number | null;

  @Column({ type: 'bigint', name: 'ShipmentTargetRef', nullable: true })
  shipmentTargetRef: number | null;

  @Column({ type: 'timestamp without time zone', name: 'ShipmentBeginningDate' })
  shipmentBeginningDate: Date;

  @Column({ type: 'character varying', name: 'ShipmentInvoiceNumber', nullable: true })
  shipmentInvoiceNumber: string | null;

  @Column({ type: 'numeric', name: 'ShipmentCost', nullable: true })
