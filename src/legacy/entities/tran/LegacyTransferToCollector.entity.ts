...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'TransferToCollector' })
export class LegacyTransferToCollector {
  @PrimaryColumn({ type: 'bigint', name: 'TransferToCollectorID' })
  transferToCollectorID: number;
