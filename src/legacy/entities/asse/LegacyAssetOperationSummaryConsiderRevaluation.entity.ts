...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'AssetOperationSummaryConsiderRevaluation' })
export class LegacyAssetOperationSummaryConsiderRevaluation {
  @PrimaryColumn({ type: 'bigint', name: 'AssetOperationSummaryConsiderRevaluationID' })
  assetOperationSummaryConsiderRevaluationID: number;
  ...
  @Column({ type: 'numeric', name: 'RemainingRevaluationSurplus' })
