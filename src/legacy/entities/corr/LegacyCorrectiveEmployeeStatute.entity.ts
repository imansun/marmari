...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'CorrectiveEmployeeStatute' })
export class LegacyCorrectiveEmployeeStatute {
  @PrimaryColumn({ type: 'bigint', name: 'CorrectiveEmployeeStatuteID' })
  correctiveEmployeeStatuteID: number;
  ...
  @Column({ type: 'bigint', name: 'BatchCorrectiveEmployeeStatuteRef', nullable: true })
  batchCorrectiveEmployeeStatuteRef: number | null;
