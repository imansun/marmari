...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'BranchCurrentAccount' })
export class LegacyBranchCurrentAccount {
  @PrimaryColumn({ type: 'bigint', name: 'BranchCurrentAccountID' })
  branchCurrentAccountID: number;
