...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ContractAccountingInformation' })
export class LegacyContractAccountingInformation {
  @PrimaryColumn({ type: 'bigint', name: 'ContractAccountingInformationID' })
  contractAccountingInformationID: number;
