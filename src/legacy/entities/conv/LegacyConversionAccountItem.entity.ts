...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ConversionAccountItem' })
export class LegacyConversionAccountItem {
  @PrimaryColumn({ type: 'bigint', name: 'ConversionAccountItemID' })
  conversionAccountItemID: number;

  @Column({ type: 'bigint', name: 'ConversionPatternRef' })
  conversionPatternRef: number;
