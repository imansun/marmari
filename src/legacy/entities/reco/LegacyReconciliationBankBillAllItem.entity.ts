...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReconciliationBankBillAllItem' })
export class LegacyReconciliationBankBillAllItem {
  @PrimaryColumn({ type: 'bigint', name: 'ReconciliationBankBillAllItemID' })
  reconciliationBankBillAllItemID: number;
