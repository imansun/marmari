...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'NSVoucherTemplateItem' })
export class LegacyNSVoucherTemplateItem {
  @PrimaryColumn({ type: 'bigint', name: 'NSVoucherTemplateItemID' })
  nSVoucherTemplateItemID: number;
  ...
  @Column({ type: 'integer', name: 'PrefixDLRelation' })
  prefixDLRelation: number;
