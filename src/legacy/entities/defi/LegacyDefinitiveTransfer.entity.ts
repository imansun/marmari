...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'DefinitiveTransfer' })
export class LegacyDefinitiveTransfer {
  @PrimaryColumn({ type: 'bigint', name: 'DefinitiveTransferID' })
  definitiveTransferID: number;
  ...
  @Column({ type: 'character varying', name: 'DeliveryOrganizationNumber' })
  deliveryOrganizationNumber: string;
  ...
  @Column({ type: 'bigint', name: 'AcceptorOrganizationRef' })
  acceptorOrganizationRef: number;
