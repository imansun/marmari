...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ServiceOperation' })
export class LegacyServiceOperation {
  @PrimaryColumn({ type: 'bigint', name: 'ServiceOperationID' })
  ...
  @Column({ type: 'integer', name: 'EquipmentStatus' })
  ...
  @Column({ type: 'bigint', name: 'ServiceOperationSetRef' })
  serviceOperationSetRef: number;
