...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ShelfHandheldVoucher' })
export class LegacyShelfHandheldVoucher {
  @PrimaryColumn({ type: 'bigint', name: 'ShelfHandheldVoucherID' })
  shelfHandheldVoucherID: number;
