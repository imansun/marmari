...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ShelfVoucherItem' })
export class LegacyShelfVoucherItem {
  @PrimaryColumn({ type: 'bigint', name: 'ShelfVoucherItemID' })
  shelfVoucherItemID: number;
  ...
  @Column({ type: 'bigint', name: 'ShelfVoucherRef' })
  shelfVoucherRef: number;
