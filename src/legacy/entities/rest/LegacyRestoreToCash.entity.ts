...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'RestoreToCash' })
export class LegacyRestoreToCash {
  @PrimaryColumn({ type: 'bigint', name: 'RestoreToCashID' })
  restoreToCashID: number;
