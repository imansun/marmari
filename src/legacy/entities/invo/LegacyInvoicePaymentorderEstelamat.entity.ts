...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InvoicePaymentorderEstelamat' })
export class LegacyInvoicePaymentorderEstelamat {
  @PrimaryColumn({ type: 'bigint', name: 'InvoicePaymentorderEstelamatID' })
  invoicePaymentorderEstelamatID: number;
