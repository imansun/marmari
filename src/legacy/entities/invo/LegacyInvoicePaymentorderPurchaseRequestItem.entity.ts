...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InvoicePaymentorderPurchaseRequestItem' })
export class LegacyInvoicePaymentorderPurchaseRequestItem {
  @PrimaryColumn({ type: 'bigint', name: 'InvoicePaymentorderPurchaseRequestItemID' })
  invoicePaymentorderPurchaseRequestItemID: number;
  ...
  @Column({ type: 'numeric', name: 'ImpositionButInquiryRate2', nullable: true })
  impositionButInquiryRate2: number | null;

  @Column({ type: 'numeric', name: 'TodayBalePurchaseBar', nullable: true })
  todayBalePurchaseBar: number | null;

  @Column({ type: 'bigint', name: 'GoodsEarmarkRef', nullable: true })
  goodsEarmarkRef: number | null;

  @Column({ type: 'numeric', name: 'KsuratTkhfyfatAmount', nullable: true })
  ksuratTkhfyfatAmount: number | null;
