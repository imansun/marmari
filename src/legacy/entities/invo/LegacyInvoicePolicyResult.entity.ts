...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InvoicePolicyResult' })
export class LegacyInvoicePolicyResult {
  @PrimaryColumn({ type: 'bigint', name: 'InvoicePolicyResultID' })
  invoicePolicyResultID: number;
