...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InvoicePaymentorderInvoicePaymentCourse' })
export class LegacyInvoicePaymentorderInvoicePaymentCourse {
  @PrimaryColumn({ type: 'bigint', name: 'InvoicePaymentorderInvoicePaymentCourseID' })
  invoicePaymentorderInvoicePaymentCourseID: number;
  ...
  @Column({ type: 'bigint', name: 'ShbaNoRef', nullable: true })
  shbaNoRef: number | null;
