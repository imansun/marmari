...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InvoicePaymentBehestEstelamat' })
export class LegacyInvoicePaymentBehestEstelamat {
  @PrimaryColumn({ type: 'bigint', name: 'InvoicePaymentBehestEstelamatID' })
  invoicePaymentBehestEstelamatID: number;
