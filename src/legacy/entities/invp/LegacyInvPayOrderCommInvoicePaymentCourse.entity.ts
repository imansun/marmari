...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InvPayOrderCommInvoicePaymentCourse' })
export class LegacyInvPayOrderCommInvoicePaymentCourse {
  @PrimaryColumn({ type: 'bigint', name: 'InvPayOrderCommInvoicePaymentCourseID' })
  invPayOrderCommInvoicePaymentCourseID: number;
