...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InvPayOrderComm' })
export class LegacyInvPayOrderComm {
  @PrimaryColumn({ type: 'bigint', name: 'InvPayOrderCommID' })
  invPayOrderCommID: number;
  ...
  @Column({ type: 'bigint', name: 'SecureExpertNameRef', nullable: true })
  secureExpertNameRef: number | null;
  ...
  @Column({ type: 'integer', name: 'Goodsgroupkind', nullable: true })
  goodsgroupkind: number | null;
  ...
  @Column({ type: 'character varying', name: 'CommissionScientificAffiliateComments', nullable: true })
  commissionScientificAffiliateComments: string | null;

  @Column({ type: 'character varying', name: 'CommissionMalayAffiliateComments', nullable: true })
  commissionMalayAffiliateComments: string | null;
