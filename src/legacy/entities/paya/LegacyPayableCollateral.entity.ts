...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'PayableCollateral' })
export class LegacyPayableCollateral {
  @PrimaryColumn({ type: 'bigint', name: 'PayableCollateralID' })
  payableCollateralID: number;
