...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'RetakeFromStore' })
export class LegacyRetakeFromStore {
  @PrimaryColumn({ type: 'bigint', name: 'RetakeFromStoreID' })
  retakeFromStoreID: number;
