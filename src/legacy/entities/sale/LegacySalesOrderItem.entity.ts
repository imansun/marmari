...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'SalesOrderItem' })
export class LegacySalesOrderItem {
  @PrimaryColumn({ type: 'bigint', name: 'SalesOrderItemID' })
  ...
  @Column({ type: 'integer', name: 'ReservationTime' })
  reservationTime: number;

  @Column({ type: 'timestamp without time zone', name: 'ConfirmationDate', nullable: true })
  confirmationDate: Date | null;

  @Column({ type: 'timestamp without time zone', name: 'ClosingDate', nullable: true })
