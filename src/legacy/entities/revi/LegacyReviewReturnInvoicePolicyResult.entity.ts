...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReviewReturnInvoicePolicyResult' })
export class LegacyReviewReturnInvoicePolicyResult {
  @PrimaryColumn({ type: 'bigint', name: 'ReviewReturnInvoicePolicyResultID' })
  reviewReturnInvoicePolicyResultID: number;
