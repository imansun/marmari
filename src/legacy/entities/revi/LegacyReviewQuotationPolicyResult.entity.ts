...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReviewQuotationPolicyResult' })
export class LegacyReviewQuotationPolicyResult {
  @PrimaryColumn({ type: 'bigint', name: 'ReviewQuotationPolicyResultID' })
  reviewQuotationPolicyResultID: number;
