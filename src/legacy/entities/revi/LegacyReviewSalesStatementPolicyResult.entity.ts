...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReviewSalesStatementPolicyResult' })
export class LegacyReviewSalesStatementPolicyResult {
  @PrimaryColumn({ type: 'bigint', name: 'ReviewSalesStatementPolicyResultID' })
  reviewSalesStatementPolicyResultID: number;
