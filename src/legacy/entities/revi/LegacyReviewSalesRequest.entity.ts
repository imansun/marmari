...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReviewSalesRequest' })
export class LegacyReviewSalesRequest {
  @Column({ type: 'bigint', name: 'SalesRequestID' })
  salesRequestID: number;

  @PrimaryColumn({ type: 'bigint', name: 'SalesRequestItemID' })
  salesRequestItemID: number;
  ...
  @Column({ type: 'numeric', name: 'ConsumedQuantity' })
  consumedQuantity: number;

  @Column({ type: 'numeric', name: 'MajorCounsumedQuantity' })
  majorCounsumedQuantity: number;

  @Column({ type: 'numeric', name: 'BiggestUnitConsumedQuantity' })
  biggestUnitConsumedQuantity: number;

  @Column({ type: 'numeric', name: 'SmallestUnitConsumedQuantity' })
  smallestUnitConsumedQuantity: number;

  @Column({ type: 'numeric', name: 'DefaultUnitConsumedQuantity' })
  defaultUnitConsumedQuantity: number;
