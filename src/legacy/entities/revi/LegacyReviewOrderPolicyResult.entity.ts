...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReviewOrderPolicyResult' })
export class LegacyReviewOrderPolicyResult {
  @PrimaryColumn({ type: 'bigint', name: 'ReviewOrderPolicyResultID' })
  reviewOrderPolicyResultID: number;
