...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReviewSalesRequestPolicyResult' })
export class LegacyReviewSalesRequestPolicyResult {
  @PrimaryColumn({ type: 'bigint', name: 'ReviewSalesRequestPolicyResultID' })
  reviewSalesRequestPolicyResultID: number;

  @Column({ type: 'bigint', name: 'SaleRequestID' })
