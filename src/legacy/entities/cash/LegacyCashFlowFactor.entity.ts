...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'CashFlowFactor' })
export class LegacyCashFlowFactor {
  @PrimaryColumn({ type: 'bigint', name: 'CashFlowFactorID' })
  cashFlowFactorID: number;
