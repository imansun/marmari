...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'AutomaticVoucherPatternDestinationSL' })
export class LegacyAutomaticVoucherPatternDestinationSL {
  @PrimaryColumn({ type: 'bigint', name: 'AutomaticVoucherPatternDestinationSLID' })
  automaticVoucherPatternDestinationSLID: number;

  @Column({ type: 'numeric', name: 'Percentage' })
  percentage: number;

  @Column({ type: 'bigint', name: 'AutomaticVoucherPatternRef' })
  automaticVoucherPatternRef: number;
