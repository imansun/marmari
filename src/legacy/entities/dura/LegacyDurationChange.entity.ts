...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'DurationChange' })
export class LegacyDurationChange {
  @PrimaryColumn({ type: 'bigint', name: 'DurationChangeID' })
  durationChangeID: number;
  ...
  @Column({ type: 'integer', name: 'DurationChangeType' })
  durationChangeType: number;
