...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'IncomeStatementItem' })
export class LegacyIncomeStatementItem {
  @PrimaryColumn({ type: 'bigint', name: 'IncomeStatementItemID' })
  incomeStatementItemID: number;

  @Column({ type: 'bigint', name: 'IncomeStatementRef' })
  incomeStatementRef: number;
