...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'PettyCashBill' })
export class LegacyPettyCashBill {
  @PrimaryColumn({ type: 'bigint', name: 'PettyCashBillID' })
  pettyCashBillID: number;
