...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'BillOfLadingItem' })
export class LegacyBillOfLadingItem {
  @PrimaryColumn({ type: 'bigint', name: 'BillOfLadingItemID' })
  billOfLadingItemID: number;
