...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ProductExtraFields' })
export class LegacyProductExtraFields {
  @PrimaryColumn({ type: 'bigint', name: 'ProductExtraFieldsID' })
  productExtraFieldsID: number;
