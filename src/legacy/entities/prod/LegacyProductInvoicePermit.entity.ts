...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ProductInvoicePermit' })
export class LegacyProductInvoicePermit {
  @PrimaryColumn({ type: 'bigint', name: 'ProductInvoicePermitID' })
  productInvoicePermitID: number;
  ...
  @Column({ type: 'text', name: 'RreferenceRefs' })
  rreferenceRefs: string;
  ...
  @Column({ type: 'character varying', name: 'ReferenceNumbers' })
  ...
  @Column({ type: 'boolean', name: 'IsExport' })
  isExport: boolean;
