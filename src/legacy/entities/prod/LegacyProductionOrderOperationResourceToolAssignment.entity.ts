...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ProductionOrderOperationResourceToolAssignment' })
export class LegacyProductionOrderOperationResourceToolAssignment {
  @PrimaryColumn({ type: 'bigint', name: 'ProductionOrderOperationResourceToolAssignmentID' })
  productionOrderOperationResourceToolAssignmentID: number;
