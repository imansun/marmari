...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReturnPermitItem' })
export class LegacyReturnPermitItem {
  @PrimaryColumn({ type: 'bigint', name: 'ReturnPermitItemID' })
  returnPermitItemID: number;
