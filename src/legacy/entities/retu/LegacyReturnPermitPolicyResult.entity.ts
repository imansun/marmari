...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReturnPermitPolicyResult' })
export class LegacyReturnPermitPolicyResult {
  @PrimaryColumn({ type: 'bigint', name: 'ReturnPermitPolicyResultID' })
  returnPermitPolicyResultID: number;
