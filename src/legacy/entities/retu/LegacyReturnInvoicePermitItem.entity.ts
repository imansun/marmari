...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReturnInvoicePermitItem' })
export class LegacyReturnInvoicePermitItem {
  @PrimaryColumn({ type: 'bigint', name: 'ReturnInvoicePermitItemID' })
  returnInvoicePermitItemID: number;
