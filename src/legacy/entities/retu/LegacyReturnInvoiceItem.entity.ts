...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReturnInvoiceItem' })
export class LegacyReturnInvoiceItem {
  ...
  @Column({ type: 'bigint', name: 'ManualQuickPriceRef', nullable: true })
  manualQuickPriceRef: number | null;

  @Column({ type: 'bigint', name: 'ReturnInvoicePermitItemRef', nullable: true })
  returnInvoicePermitItemRef: number | null;
