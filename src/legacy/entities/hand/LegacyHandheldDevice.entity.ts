...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'HandheldDevice' })
export class LegacyHandheldDevice {
  @PrimaryColumn({ type: 'bigint', name: 'HandheldDeviceID' })
  handheldDeviceID: number;
