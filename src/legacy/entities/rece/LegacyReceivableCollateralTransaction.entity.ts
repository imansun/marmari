...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReceivableCollateralTransaction' })
export class LegacyReceivableCollateralTransaction {
  @PrimaryColumn({ type: 'bigint', name: 'ReceivableCollateralTransactionID' })
  receivableCollateralTransactionID: number;
