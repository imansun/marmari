...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReceiptPermitItemTrackingFactor' })
export class LegacyReceiptPermitItemTrackingFactor {
  @PrimaryColumn({ type: 'bigint', name: 'ReceiptPermitItemTrackingFactorID' })
  receiptPermitItemTrackingFactorID: number;

  @Column({ type: 'bigint', name: 'ReceiptPermitItemRef' })
  receiptPermitItemRef: number;
