...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReceiptCashMoney' })
export class LegacyReceiptCashMoney {
  @PrimaryColumn({ type: 'bigint', name: 'ReceiptCashMoneyID' })
  receiptCashMoneyID: number;
