...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReceiptDeposit' })
export class LegacyReceiptDeposit {
  @PrimaryColumn({ type: 'bigint', name: 'ReceiptDepositID' })
  receiptDepositID: number;
