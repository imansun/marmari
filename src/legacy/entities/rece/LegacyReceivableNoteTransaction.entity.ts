...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReceivableNoteTransaction' })
export class LegacyReceivableNoteTransaction {
  @PrimaryColumn({ type: 'bigint', name: 'ReceivableNoteTransactionID' })
  receivableNoteTransactionID: number;
