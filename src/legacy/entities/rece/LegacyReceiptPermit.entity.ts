...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReceiptPermit' })
export class LegacyReceiptPermit {
  @PrimaryColumn({ type: 'bigint', name: 'ReceiptPermitID' })
  receiptPermitID: number;
  ...
  @Column({ type: 'integer', name: 'ReceiptVoucherType' })
  receiptVoucherType: number;
