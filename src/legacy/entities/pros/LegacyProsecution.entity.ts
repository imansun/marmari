...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'Prosecution' })
export class LegacyProsecution {
  @PrimaryColumn({ type: 'bigint', name: 'ProsecutionID' })
  ...
  @Column({ type: 'integer', name: 'ActionMethod', nullable: true })
  actionMethod: number | null;
