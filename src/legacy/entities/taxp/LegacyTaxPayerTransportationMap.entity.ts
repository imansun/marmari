...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'TaxPayerTransportationMap' })
export class LegacyTaxPayerTransportationMap {
  ...
  @Column({ type: 'timestamp without time zone', name: 'ValidTo' })
  validTo: Date;
