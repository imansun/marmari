...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'EmployeeRetirementForm37' })
export class LegacyEmployeeRetirementForm37 {
  @PrimaryColumn({ type: 'bigint', name: 'EmployeeRetirementForm37ID' })
  employeeRetirementForm37ID: number;
