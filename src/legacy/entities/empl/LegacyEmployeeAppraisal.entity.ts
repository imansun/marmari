...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'EmployeeAppraisal' })
export class LegacyEmployeeAppraisal {
  @PrimaryColumn({ type: 'bigint', name: 'EmployeeAppraisalID' })
  ...
  @Column({ type: 'character varying', name: 'Result' })
  result: string;
