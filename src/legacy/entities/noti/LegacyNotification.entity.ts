...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'Notification' })
export class LegacyNotification {
  @PrimaryColumn({ type: 'bigint', name: 'NotificationID' })
  ...
  @Column({ type: 'bigint', name: 'ReportedByRef', nullable: true })
  reportedByRef: number | null;
