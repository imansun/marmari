...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'MaintenanceExpenditures' })
export class LegacyMaintenanceExpenditures {
  @PrimaryColumn({ type: 'bigint', name: 'MaintenanceExpendituresID' })
  maintenanceExpendituresID: number;
