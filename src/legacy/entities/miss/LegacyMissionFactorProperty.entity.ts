...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'MissionFactorProperty' })
export class LegacyMissionFactorProperty {
  @PrimaryColumn({ type: 'bigint', name: 'MissionFactorPropertyID' })
  missionFactorPropertyID: number;
