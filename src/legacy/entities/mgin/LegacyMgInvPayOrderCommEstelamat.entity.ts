...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'MgInvPayOrderCommEstelamat' })
export class LegacyMgInvPayOrderCommEstelamat {
  @PrimaryColumn({ type: 'bigint', name: 'MgInvPayOrderCommEstelamatID' })
  mgInvPayOrderCommEstelamatID: number;
