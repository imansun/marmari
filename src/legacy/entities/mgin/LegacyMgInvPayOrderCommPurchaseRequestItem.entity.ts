...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'MgInvPayOrderCommPurchaseRequestItem' })
export class LegacyMgInvPayOrderCommPurchaseRequestItem {
  @PrimaryColumn({ type: 'bigint', name: 'MgInvPayOrderCommPurchaseRequestItemID' })
  mgInvPayOrderCommPurchaseRequestItemID: number;
  ...
  @Column({ type: 'numeric', name: 'InquiryAmounti', nullable: true })
  inquiryAmounti: number | null;
  ...
  @Column({ type: 'numeric', name: 'PurchaseFreshTada', nullable: true })
  purchaseFreshTada: number | null;
