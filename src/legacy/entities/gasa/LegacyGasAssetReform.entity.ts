...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'GasAssetReform' })
export class LegacyGasAssetReform {
  @PrimaryColumn({ type: 'bigint', name: 'GasAssetReformID' })
  gasAssetReformID: number;
