...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReferenceOperationResourceToolAssignment' })
export class LegacyReferenceOperationResourceToolAssignment {
  @PrimaryColumn({ type: 'bigint', name: 'ReferenceOperationResourceToolAssignmentID' })
  referenceOperationResourceToolAssignmentID: number;
