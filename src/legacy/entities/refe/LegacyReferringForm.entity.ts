...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ReferringForm' })
export class LegacyReferringForm {
  @PrimaryColumn({ type: 'bigint', name: 'ReferringFormID' })
  referringFormID: number;
