...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'PriorYearAdjustmentItem' })
export class LegacyPriorYearAdjustmentItem {
  @PrimaryColumn({ type: 'bigint', name: 'PriorYearAdjustmentItemID' })
  priorYearAdjustmentItemID: number;

  @Column({ type: 'bigint', name: 'PriorYearAdjustmentRef' })
  priorYearAdjustmentRef: number;
  ...
  @Column({ type: 'integer', name: 'SequenceNumber' })
  ...
  @Column({ type: 'integer', name: 'PriorYearAdjustmentItemType' })
  priorYearAdjustmentItemType: number;
