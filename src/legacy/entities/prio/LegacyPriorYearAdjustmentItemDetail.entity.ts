...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'PriorYearAdjustmentItemDetail' })
export class LegacyPriorYearAdjustmentItemDetail {
  @PrimaryColumn({ type: 'bigint', name: 'PriorYearAdjustmentItemDetailID' })
  priorYearAdjustmentItemDetailID: number;

  @Column({ type: 'bigint', name: 'PriorYearAdjustmentItemRef' })
  priorYearAdjustmentItemRef: number;
  ...
  @Column({ type: 'integer', name: 'PriorYearAdjustmentAccountType' })
  priorYearAdjustmentAccountType: number;
