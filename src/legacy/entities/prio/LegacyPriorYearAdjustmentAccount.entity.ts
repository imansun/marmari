...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'PriorYearAdjustmentAccount' })
export class LegacyPriorYearAdjustmentAccount {
  @PrimaryColumn({ type: 'bigint', name: 'PriorYearAdjustmentAccountID' })
  priorYearAdjustmentAccountID: number;
