...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'CoursePlanAppraisal' })
export class LegacyCoursePlanAppraisal {
  @PrimaryColumn({ type: 'bigint', name: 'CoursePlanAppraisalID' })
  coursePlanAppraisalID: number;
  ...
  @Column({ type: 'bigint', name: 'AppraisalDistributionRef', nullable: true })
  appraisalDistributionRef: number | null;
