...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'WriteOffStatementItem' })
export class LegacyWriteOffStatementItem {
  @PrimaryColumn({ type: 'bigint', name: 'WriteOffStatementItemID' })
  writeOffStatementItemID: number;

  @Column({ type: 'bigint', name: 'WriteOffStatementRef' })
  writeOffStatementRef: number;
  ...
  @Column({ type: 'numeric', name: 'WriteOffDebit', nullable: true })
  writeOffDebit: number | null;

  @Column({ type: 'numeric', name: 'WriteOffCredit', nullable: true })
  writeOffCredit: number | null;

  @Column({ type: 'integer', name: 'WriteOffAccountType' })
  writeOffAccountType: number;

  @Column({ type: 'numeric', name: 'WriteOffDebitBalance', nullable: true })
  writeOffDebitBalance: number | null;

  @Column({ type: 'numeric', name: 'WriteOffCreditBalance', nullable: true })
  writeOffCreditBalance: number | null;
