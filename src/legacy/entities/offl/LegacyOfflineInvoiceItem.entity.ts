...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'OfflineInvoiceItem' })
export class LegacyOfflineInvoiceItem {
  @PrimaryColumn({ type: 'bigint', name: 'OfflineInvoiceItemID' })
  offlineInvoiceItemID: number;
  ...
  @Column({ type: 'bigint', name: 'CashRegisterDeviceRef', nullable: true })
  cashRegisterDeviceRef: number | null;

  @Column({ type: 'character varying', name: 'DeviceReceiptCode', nullable: true })
