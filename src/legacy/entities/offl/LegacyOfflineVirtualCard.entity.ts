...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'OfflineVirtualCard' })
export class LegacyOfflineVirtualCard {
  @PrimaryColumn({ type: 'bigint', name: 'OfflineVirtualCardID' })
  offlineVirtualCardID: number;
