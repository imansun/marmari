...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'CompensationFactorProperty' })
export class LegacyCompensationFactorProperty {
  @PrimaryColumn({ type: 'bigint', name: 'CompensationFactorPropertyID' })
  compensationFactorPropertyID: number;
  ...
  @Column({ type: 'integer', name: 'Attributes' })
  attributes: number;
