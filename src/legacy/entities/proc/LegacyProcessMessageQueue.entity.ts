...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ProcessMessageQueue' })
export class LegacyProcessMessageQueue {
  @PrimaryColumn({ type: 'bigint', name: 'ProcessMessageQueueID' })
  processMessageQueueID: number;
