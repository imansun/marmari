...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ProcurementDeliveryExtensionSideProduct' })
export class LegacyProcurementDeliveryExtensionSideProduct {
  @PrimaryColumn({ type: 'bigint', name: 'ProcurementDeliveryExtensionSideProductID' })
  procurementDeliveryExtensionSideProductID: number;
  ...
  @Column({ type: 'bigint', name: 'ProcurementOrderExtensionSideProductRef' })
  procurementOrderExtensionSideProductRef: number;
