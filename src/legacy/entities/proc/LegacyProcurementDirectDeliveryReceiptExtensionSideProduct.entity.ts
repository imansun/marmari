...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ProcurementDirectDeliveryReceiptExtensionSideProduct' })
export class LegacyProcurementDirectDeliveryReceiptExtensionSideProduct {
  @PrimaryColumn({ type: 'bigint', name: 'ProcurementDirectDeliveryReceiptExtensionSideProductID' })
  procurementDirectDeliveryReceiptExtensionSideProductID: number;
  ...
  @Column({ type: 'bigint', name: 'ProcurementDeliveryExtensionSideProductRef' })
  procurementDeliveryExtensionSideProductRef: number;
