...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ProcessXMLSchemaDefination' })
export class LegacyProcessXMLSchemaDefination {
  @PrimaryColumn({ type: 'bigint', name: 'ProcessXMLSchemaDefinationID' })
  processXMLSchemaDefinationID: number;
