...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'BatchEmployeeStatute' })
export class LegacyBatchEmployeeStatute {
  @PrimaryColumn({ type: 'bigint', name: 'BatchEmployeeStatuteID' })
  batchEmployeeStatuteID: number;
