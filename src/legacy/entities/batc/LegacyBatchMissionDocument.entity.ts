...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'BatchMissionDocument' })
export class LegacyBatchMissionDocument {
  @PrimaryColumn({ type: 'bigint', name: 'BatchMissionDocumentID' })
  batchMissionDocumentID: number;
