...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'EReceiptTransaction' })
export class LegacyEReceiptTransaction {
  @PrimaryColumn({ type: 'bigint', name: 'EReceiptTransactionID' })
  eReceiptTransactionID: number;
