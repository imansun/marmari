...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'StoreSpecificInvoice' })
export class LegacyStoreSpecificInvoice {
  @PrimaryColumn({ type: 'bigint', name: 'StoreSpecificInvoiceID' })
  storeSpecificInvoiceID: number;
