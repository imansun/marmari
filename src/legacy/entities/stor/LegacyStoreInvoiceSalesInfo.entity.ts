...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'StoreInvoiceSalesInfo' })
export class LegacyStoreInvoiceSalesInfo {
  @PrimaryColumn({ type: 'bigint', name: 'StoreInvoiceSalesInfoID' })
  storeInvoiceSalesInfoID: number;
