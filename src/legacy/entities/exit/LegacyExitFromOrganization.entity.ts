...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'ExitFromOrganization' })
export class LegacyExitFromOrganization {
  @PrimaryColumn({ type: 'bigint', name: 'ExitFromOrganizationID' })
  exitFromOrganizationID: number;
