...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'AdjustmentFactorPaymentInformation' })
export class LegacyAdjustmentFactorPaymentInformation {
  @PrimaryColumn({ type: 'bigint', name: 'AdjustmentFactorPaymentInformationID' })
  adjustmentFactorPaymentInformationID: number;
