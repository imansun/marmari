...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'AdjustmentVoucherItem' })
export class LegacyAdjustmentVoucherItem {
  @PrimaryColumn({ type: 'bigint', name: 'AdjustmentVoucherItemID' })
  adjustmentVoucherItemID: number;

  @Column({ type: 'bigint', name: 'AdjustmentVoucherRef' })
  adjustmentVoucherRef: number;
