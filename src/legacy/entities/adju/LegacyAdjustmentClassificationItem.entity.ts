...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'AdjustmentClassificationItem' })
export class LegacyAdjustmentClassificationItem {
  @PrimaryColumn({ type: 'bigint', name: 'AdjustmentClassificationItemID' })
  adjustmentClassificationItemID: number;

  @Column({ type: 'bigint', name: 'AdjustmentClassificationRef' })
  adjustmentClassificationRef: number;
  ...
  @Column({ type: 'integer', name: 'RelationNumber', nullable: true })
  relationNumber: number | null;

  @Column({ type: 'integer', name: 'RelationLevel' })
  relationLevel: number;

  @Column({ type: 'integer', name: 'RowNumber' })
  rowNumber: number;

  @Column({ type: 'integer', name: 'RelationNumberLevel' })
  relationNumberLevel: number;

  @Column({ type: 'boolean', name: 'IsAdjustment', nullable: true })
