...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'MappingStructureOutput' })
export class LegacyMappingStructureOutput {
  @PrimaryColumn({ type: 'bigint', name: 'MappingStructureOutputID' })
  mappingStructureOutputID: number;
