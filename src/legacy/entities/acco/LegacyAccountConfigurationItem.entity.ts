...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'AccountConfigurationItem' })
export class LegacyAccountConfigurationItem {
  @PrimaryColumn({ type: 'bigint', name: 'AccountConfigurationItemID' })
  accountConfigurationItemID: number;

  @Column({ type: 'bigint', name: 'AccountConfigurationRef' })
  accountConfigurationRef: number;
  ...
  @Column({ type: 'integer', name: 'CurrencyType', nullable: true })
  currencyType: number | null;

  @Column({ type: 'integer', name: 'SalePriceElementType', nullable: true })
  salePriceElementType: number | null;

  @Column({ type: 'bigint', name: 'PurchasePriceElementRef', nullable: true })
  purchasePriceElementRef: number | null;

  @Column({ type: 'integer', name: 'AssetStateType', nullable: true })
  assetStateType: number | null;
  ...
  @Column({ type: 'bigint', name: 'ExpenditureType', nullable: true })
  expenditureType: number | null;
