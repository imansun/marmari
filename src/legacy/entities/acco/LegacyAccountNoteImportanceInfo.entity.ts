...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'AccountNoteImportanceInfo' })
export class LegacyAccountNoteImportanceInfo {
  @PrimaryColumn({ type: 'bigint', name: 'AccountNoteImportanceInfoID' })
  accountNoteImportanceInfoID: number;

  @Column({ type: 'bigint', name: 'AccountNoteRef' })
  accountNoteRef: number;

  @Column({ type: 'bigint', name: 'TempAccountNoteStructureRef' })
  tempAccountNoteStructureRef: number;
