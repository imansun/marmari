...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'AccountMappingItem' })
export class LegacyAccountMappingItem {
  @PrimaryColumn({ type: 'bigint', name: 'AccountMappingItemID' })
  accountMappingItemID: number;

  @Column({ type: 'bigint', name: 'AccountMappingRef' })
  accountMappingRef: number;

  @Column({ type: 'integer', name: 'CurrentLevelMapped' })
  currentLevelMapped: number;
  ...
  @Column({ type: 'boolean', name: 'IsContinued' })
  isContinued: boolean;
