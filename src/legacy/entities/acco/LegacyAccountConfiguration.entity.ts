...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'AccountConfiguration' })
export class LegacyAccountConfiguration {
  @PrimaryColumn({ type: 'bigint', name: 'AccountConfigurationID' })
  accountConfigurationID: number;

  @Column({ type: 'bigint', name: 'CalculationAreaRef', nullable: true })
  calculationAreaRef: number | null;

  @Column({ type: 'integer', name: 'AccountGroupType' })
