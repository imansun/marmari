...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'BankTransfer' })
export class LegacyBankTransfer {
  @PrimaryColumn({ type: 'bigint', name: 'BankTransferID' })
  ...
  @Column({ type: 'bigint', name: 'AggrigationRef', nullable: true })
  aggrigationRef: number | null;

  @Column({ type: 'character varying', name: 'AggrigationNumber', nullable: true })
  aggrigationNumber: string | null;
