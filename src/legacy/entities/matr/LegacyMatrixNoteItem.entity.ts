...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'MatrixNoteItem' })
export class LegacyMatrixNoteItem {
  @PrimaryColumn({ type: 'bigint', name: 'MatrixNoteItemID' })
  matrixNoteItemID: number;
