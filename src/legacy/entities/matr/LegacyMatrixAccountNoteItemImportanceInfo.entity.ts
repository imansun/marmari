...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'MatrixAccountNoteItemImportanceInfo' })
export class LegacyMatrixAccountNoteItemImportanceInfo {
  @PrimaryColumn({ type: 'bigint', name: 'MatrixAccountNoteItemImportanceInfoID' })
  matrixAccountNoteItemImportanceInfoID: number;
