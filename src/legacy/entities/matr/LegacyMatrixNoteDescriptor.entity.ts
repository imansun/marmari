...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'MatrixNoteDescriptor' })
export class LegacyMatrixNoteDescriptor {
  @PrimaryColumn({ type: 'bigint', name: 'MatrixNoteDescriptorID' })
  matrixNoteDescriptorID: number;
