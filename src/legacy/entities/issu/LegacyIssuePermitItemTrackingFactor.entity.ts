...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'IssuePermitItemTrackingFactor' })
export class LegacyIssuePermitItemTrackingFactor {
  @PrimaryColumn({ type: 'bigint', name: 'IssuePermitItemTrackingFactorID' })
  issuePermitItemTrackingFactorID: number;

  @Column({ type: 'bigint', name: 'IssuePermitItemRef' })
  issuePermitItemRef: number;
