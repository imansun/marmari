...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InsuranceAccountConfiguration' })
export class LegacyInsuranceAccountConfiguration {
  @PrimaryColumn({ type: 'bigint', name: 'InsuranceAccountConfigurationID' })
  insuranceAccountConfigurationID: number;

  @Column({ type: 'integer', name: 'InsuranceAccountGroupType' })
  insuranceAccountGroupType: number;
