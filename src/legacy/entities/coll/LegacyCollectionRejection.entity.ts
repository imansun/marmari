...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'CollectionRejection' })
export class LegacyCollectionRejection {
  @PrimaryColumn({ type: 'bigint', name: 'CollectionRejectionID' })
  collectionRejectionID: number;
