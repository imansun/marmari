...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'Inspection' })
export class LegacyInspection {
  @PrimaryColumn({ type: 'bigint', name: 'InspectionID' })
  inspectionID: number;
  ...
  @Column({ type: 'boolean', name: 'IsAdvance', default: false })
  isAdvance: boolean;
