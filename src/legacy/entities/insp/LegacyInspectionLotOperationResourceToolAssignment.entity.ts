...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InspectionLotOperationResourceToolAssignment' })
export class LegacyInspectionLotOperationResourceToolAssignment {
  @PrimaryColumn({ type: 'bigint', name: 'InspectionLotOperationResourceToolAssignmentID' })
  inspectionLotOperationResourceToolAssignmentID: number;

  @Column({ type: 'bigint', name: 'InspectionLotOperationRef' })
  inspectionLotOperationRef: number;

  @Column({ type: 'bigint', name: 'InspectionLotOperationCharacteristicRef', nullable: true })
  inspectionLotOperationCharacteristicRef: number | null;
