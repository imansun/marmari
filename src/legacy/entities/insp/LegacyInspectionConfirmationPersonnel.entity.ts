...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'InspectionConfirmationPersonnel' })
export class LegacyInspectionConfirmationPersonnel {
  @PrimaryColumn({ type: 'bigint', name: 'InspectionConfirmationPersonnelID' })
  inspectionConfirmationPersonnelID: number;
