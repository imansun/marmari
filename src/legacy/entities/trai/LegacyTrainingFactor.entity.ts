...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'TrainingFactor' })
export class LegacyTrainingFactor {
  @PrimaryColumn({ type: 'bigint', name: 'TrainingFactorID' })
  trainingFactorID: number;
