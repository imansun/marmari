...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'TrainingFactorDataItem' })
export class LegacyTrainingFactorDataItem {
  @PrimaryColumn({ type: 'bigint', name: 'TrainingFactorDataItemID' })
  trainingFactorDataItemID: number;
