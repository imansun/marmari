...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'TrainingAssessmentFactorDataTrainerItem' })
export class LegacyTrainingAssessmentFactorDataTrainerItem {
  @PrimaryColumn({ type: 'bigint', name: 'TrainingAssessmentFactorDataTrainerItemID' })
  trainingAssessmentFactorDataTrainerItemID: number;
