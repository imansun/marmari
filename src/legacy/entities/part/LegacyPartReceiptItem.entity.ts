...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'PartReceiptItem' })
export class LegacyPartReceiptItem {
  @PrimaryColumn({ type: 'bigint', name: 'PartReceiptItemID' })
  partReceiptItemID: number;

  @Column({ type: 'bigint', name: 'PartReceiptRef' })
  partReceiptRef: number;
