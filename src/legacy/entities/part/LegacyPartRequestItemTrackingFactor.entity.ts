...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'PartRequestItemTrackingFactor' })
export class LegacyPartRequestItemTrackingFactor {
  @PrimaryColumn({ type: 'bigint', name: 'PartRequestItemTrackingFactorID' })
  partRequestItemTrackingFactorID: number;
