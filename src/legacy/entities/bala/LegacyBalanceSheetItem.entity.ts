...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'BalanceSheetItem' })
export class LegacyBalanceSheetItem {
  @PrimaryColumn({ type: 'bigint', name: 'BalanceSheetItemID' })
  balanceSheetItemID: number;

  @Column({ type: 'bigint', name: 'BalanceSheetRef' })
  balanceSheetRef: number;
