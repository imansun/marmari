...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'WorkOrderOperationResourceToolAssignment' })
export class LegacyWorkOrderOperationResourceToolAssignment {
  @PrimaryColumn({ type: 'bigint', name: 'WorkOrderOperationResourceToolAssignmentID' })
  workOrderOperationResourceToolAssignmentID: number;
