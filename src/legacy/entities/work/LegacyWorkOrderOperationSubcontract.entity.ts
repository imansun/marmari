...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'WorkOrderOperationSubcontract' })
export class LegacyWorkOrderOperationSubcontract {
  @PrimaryColumn({ type: 'bigint', name: 'WorkOrderOperationSubcontractID' })
  workOrderOperationSubcontractID: number;
