...
@Entity({ schema: 'sepidejam_sepidejam_sg3', name: 'WorkingShiftSpecialDay' })
export class LegacyWorkingShiftSpecialDay {
  @PrimaryColumn({ type: 'bigint', name: 'WorkingShiftSpecialDayID' })
  workingShiftSpecialDayID: number;

  @Column({ type: 'bigint', name: 'WorkingShiftRef' })
  workingShiftRef: number;

  @Column({ type: 'bigint', name: 'SpecialDayRef' })
  specialDayRef: number;
